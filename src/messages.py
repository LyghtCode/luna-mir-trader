...
def get_mir_sell_dict(belief_price: float, params: Params) -> Dict:
    msg = get_sell_msg(params.spread, belief_price)
    amount = str(to_u_unit(params.amount_mspy))
    return {
        "send": {
            "amount": amount,
            "contract": const.luna_mspy,
            "msg": msg
        }
    }
...
def get_mir_buy_dict(belief_price: float, params: Params) -> Dict:
